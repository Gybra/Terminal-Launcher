...
public enum class SettingsEntry(public val key: String, public val label: String = "") {
    ...
    SHELL("shell", "Shell"),
    THEME("theme", "Theme"),
    NOTIFICATION_ACCESS("notification-access", "Notification access"),
    NOTIFICATION_ENABLED("notification-enabled", "Enabled"),
    NOTIFICATION_DISABLED("notification-disabled", "Off — open Android settings"),
    INVALID_BADGE_COLOR("invalid-badge-color", "Enter a color as #RRGGBB"),
    BADGE_RESET("badge-reset", "Use theme default"),
    BADGE_PREVIEW("badge-preview", "Preview"),
    BADGE_BACKGROUND("badge-background", "Badge background (#RRGGBB)"),
    BADGE_TEXT("badge-text", "Badge text (#RRGGBB)"),
