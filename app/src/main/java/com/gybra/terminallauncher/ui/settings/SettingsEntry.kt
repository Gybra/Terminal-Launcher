...
public enum class SettingsEntry(public val key: String, public val label: String = "") {
    ...
    NOTIFICATION_ENABLED("notification-enabled", "on"),
    NOTIFICATION_DISABLED("notification-disabled", "off"),
    NOTIFICATION_SETTINGS("notification-settings", "< android settings"),
    BADGE_RESET("badge-reset", "< theme default"),
    BADGE_PREVIEW("badge-preview", "Preview"),
    BADGE_SIZE("badge-size", "Badge size"),
    BADGE_BACKGROUND("badge-background", "Badge background"),
    BADGE_TEXT("badge-text", "Badge text"),
